...
public class leetCode2512 {
     ...
     * <p>
     * 然后对于每个学生，我们把他的评语按照空格分成单词，再统计学生总分 score，再把 [−score，id] 存入数组中。
     * <p>
     * 最后对这个数组排序，优先对第一元素进行排序，最后前 k个学生就是我们要求的结果，返回前 k 个学生的 id。
     */
