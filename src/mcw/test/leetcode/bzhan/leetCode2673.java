...
public class leetCode2673 {
     ...
     * 我们首先考虑所有的叶结点。
     * <p>
     * 对于任一叶结点，它的值为 x，它的兄弟节点的值为 y。可以发现，对于树上的其余节点，它们要么同时是这两个叶节点的祖先，
     * 要么同时不是这两个叶节点的祖先。对这些节点进行一次操作，要么同时增加了根到这两个叶节点的路径值 1，要么没有任何效果。
     ...
     * <p>
     * 因此，所有的叶节点都无需进行操作。我们就可以将它们全部移除。为了使得路径值保持不变，我们可以将叶节点的值增加至它们的双亲节点。
