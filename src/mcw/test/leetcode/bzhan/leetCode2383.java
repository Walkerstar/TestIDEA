...
public class leetCode2383 {
    public int minNumberOfHours(int initialEnergy, int initialExperience, int[] energy, int[] experience) {
        ...
        //精力越打越少，所有 直接计算 全部队手的 精力之和 加 1 ，再减去 初始精力，即可算出 精力 需要训练的时间
        ...
        for (int i : experience) {
            if (initialExperience <= i) {
                ...
                //加上补充后的赛前训练时间 ，会打赢这个队手，
                // 那么此时的经验值 为 initialExperience + i + (i- initialExperience) + 1 ,
                // 简化后得到 2 * i + 1
